...
public class MainActivity
    ...
    public void onLongPress(MotionEvent motionEvent) {
        ...
        byte[] OCGCover = PublicFunction.getByteFromDrawable(MainActivity.this, R.drawable.ic_logo);
    ...
    private void updateAnnotation(String referenceHash, LinkTapEvent event) {
        ...
        byte[] newOCGCover = PublicFunction.getByteFromDrawable(MainActivity.this, R.drawable.ic_logo_red);
